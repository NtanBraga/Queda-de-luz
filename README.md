...
Repositório para o projeto InfraLA
...
![Vue](https://img.shields.io/badge/vuejs-%2335495e.svg?logo=vuedotjs&logoColor=%234FC08D)
...
Para a execução do seu banco de dados, vá para:

```
cd Backend
```

E execute este comando para inicia-lo:
...
<div align="center">
  <img width="1915" height="988" alt="Image" src="https://github.com/user-attachments/assets/6f203935-278a-4463-93cc-18af5757a6d8" />
</div>
