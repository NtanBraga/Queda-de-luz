...
public class AutoUpdateRecentReportsService : IHostedService, IDisposable
{
    ...
    {
        this._timer = new Timer(AutoUpdateRecentReports, null, TimeSpan.Zero, TimeSpan.FromHours(defaultIntervalTimeHours));
        return Task.CompletedTask;
    }

    private async void AutoUpdateRecentReports(object? _)
    {
